...
export function Sidebar({ isModalOpen, setIsModalOpen, excelModal, setExcelModal }) {
    ...
    <aside className="w-64 bg-white border-r border-gray-200 flex flex-col shrink-0 z-20">
        ...
        <div className="p-4 border-t border-gray-100">
           <button 
             ...
             className=" w-full flex items-center justify-center gap-2 bg-white text-black hover:bg-red-600 hover:text-white py-3 rounded-xl shadow-lg hover:shadow-red-200 transition-all active:scale-95 font-medium text-sm"
           >
  ...
  className="mt-4 w-full flex items-center justify-center gap-2 bg-red-500 hover:bg-red-600 text-white py-3 rounded-xl shadow-lg shadow-red-200 transition-all active:scale-95 font-medium text-sm"
>
  <LogOut size={18} />
  Logout
</button>
